...
<?php if(!empty($url)): ?>
	<figure class="image <?php echo $modifier; ?> <?php echo $lazyload_class; ?>" data-lazy-image-root>
		<div class="image-inner">
			<div class="image-object <?php echo $object_modifier; ?>" <?php echo $style_tag; ?> data-lazy-image>
				<?php if(!empty($lazyload)): ?>
					<img class="image-element" data-src="<?php echo $url; ?>" alt="<?php echo $caption; ?>" data-lazy-image-trigger/>
				<?php else: ?>
					<img class="image-element" src="<?php echo $url; ?>" alt="<?php echo $caption; ?>"/>
				<?php endif; ?>
